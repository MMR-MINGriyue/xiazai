const zhCN = {
  'zh_CN': {
    ...
    'maxRunning': '最大下载数',
    'globalRateLimit': '全局限速',
    'globalRateLimitHit': 'KB/s，0 表示不限速',
    'globalRateLimitOff': '不限速',
    'sftpConnections': 'SFTP 连接数',
    'ftpConnections': 'FTP 连接数',
    'todayTraffic': '今日流量',
    'filterAll': '全部',
    'filterRunning': '下载中',
    'filterWaiting': '等待',
    'filterError': '失败',
    'filterPaused': '已暂停',
    'noRunningTasks': '无进行中任务',
    'tasksRunning': '@count 个任务下载中',
    'videoBinariesMissing': '缺少视频组件',
    'videoBinariesMissingTip': '未找到：@missing。可自动下载或手动安装 yt-dlp / ffmpeg。',
    'videoResolving': '正在解析视频',
    'videoNoFormats': '未找到可用清晰度',
    'videoDownloadCreated': '视频下载已创建',
    'videoDownloadCreatedTip': '@title · @format',
    'videoInstallBins': '安装组件',
    'videoInstallRunning': '正在下载 yt-dlp / ffmpeg…',
    'videoInstallDone': '视频组件安装完成',
    'videoInstallFail': '视频组件安装失败',
    'videoFormats': '选择清晰度',
    'unknownSize': '大小未知',
    'videoJobPending': '视频排队中',
    'videoJobDownloading': '视频下载中',
    'videoJobMerging': '音视频合并中',
    'videoJobDone': '视频合并完成',
    'videoJobError': '视频合并失败',
    'floatWindow': '悬浮窗',
    'floatWindowOn': '显示悬浮进度',
    'floatWindowOff': '退出悬浮进度',
    'idle': '空闲',
