const enUS = {
  'en_US': {
    ...
    'globalRateLimit': 'Global Speed Limit',
    'globalRateLimitHit': 'KB/s, 0 = unlimited',
    'globalRateLimitOff': 'Unlimited',
    'sftpConnections': 'SFTP Connections',
    'ftpConnections': 'FTP Connections',
    'todayTraffic': 'Today Traffic',
    'filterAll': 'All',
    'filterRunning': 'Downloading',
    'filterWaiting': 'Waiting',
    'filterError': 'Failed',
    'filterPaused': 'Paused',
    'noRunningTasks': 'No active tasks',
    'tasksRunning': '@count downloading',
    'videoBinariesMissing': 'Video components missing',
    'videoBinariesMissingTip':
        'Not found: @missing. Install yt-dlp / ffmpeg automatically or manually.',
    'videoResolving': 'Resolving video',
    'videoNoFormats': 'No available formats',
    'videoDownloadCreated': 'Video download created',
    'videoDownloadCreatedTip': '@title · @format',
    'videoInstallBins': 'Install components',
    'videoInstallRunning': 'Downloading yt-dlp / ffmpeg…',
    'videoInstallDone': 'Video components installed',
    'videoInstallFail': 'Failed to install video components',
    'videoFormats': 'Select quality',
    'unknownSize': 'Unknown size',
    'videoJobPending': 'Video queued',
    'videoJobDownloading': 'Video downloading',
    'videoJobMerging': 'Merging A/V',
    'videoJobDone': 'Video merge done',
    'videoJobError': 'Video merge failed',
    'floatWindow': 'Float window',
    'floatWindowOn': 'Show float progress',
    'floatWindowOff': 'Exit float progress',
    'idle': 'Idle',
